...
always @(*)begin
    if(zero != zero0) begin
        $display("ADD_OverFlow = %h ,ADD_result = %h,u_alu_type = %h ,alu_crtl = %h,opdata1 = %h, opdata2 = %h ,LESS_M1 = %h ,LESS_M2 = %h ,zero = %h,zero0 = %h",ADD_OverFlow,ADD_result,u_alu_type,alu_crtl,opdata1,opdata2,LESS_M1,LESS_M2,zero,zero0);
    end
end
