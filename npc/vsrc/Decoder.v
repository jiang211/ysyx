...
assign ecall  = ( opcode==7'b1110011 ) & ( funct7==7'b0 ) & ( instr[24:20]==5'b00000 ) ;
assign mret   = ( opcode==7'b1110011 ) & ( funct7==7'b0 ) & ( instr[24:20]==5'b00110 ) ;
...
assign immC_num =   (instr[31:20] == 0x341) ? 32'd32 :
                    (instr[31:20] == 0x300) ? 32'd33 :
                    (instr[31:20] == 0x342) ? 32'd34 :
                    (instr[31:20] == 0x305) ? 32'd35 : 32'd0;
